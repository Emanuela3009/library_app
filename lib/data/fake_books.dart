...
final List<Book> popularBooks = [
  Book(
    ...
    imagePath: "assets/books/greatgasby.jpeg",
    rating: 0,
    userState: "To Read",
    isUserBook: false,
  ),
  Book(
    ...
    imagePath: "assets/books/harrypott.jpeg",
    rating: 0,
    userState: "To Read",
    isUserBook: false,
  ),
  Book(
    ...
    imagePath: "assets/books/1984.jpeg",
    rating: 0,
    userState: "To Read",
    isUserBook: false,
  ),
  Book(
    ...
    imagePath: "assets/books/lordofrings.jpeg",
    rating: 0,
    userState: "To Read",
    isUserBook: false,
  ),
  Book(
    ...
    imagePath: "assets/books/doriangrey.jpeg",
    rating: 0,
    userState: "To Read",
    isUserBook: false,
  ),
  Book(
    ...
    imagePath: "assets/books/frankenstein.jpeg",
    rating: 0,
    userState: "To Read",
    isUserBook: false,
  ),
  Book(
    ...
    genre: "Fable",
    plot:"A pilot stranded in the desert meets a young prince from another planet.",
    imagePath: "assets/books/littleprince.jpeg",
    rating: 0,
    userState: "To Read",
    isUserBook: false,
  ),
  Book(
    ...
    imagePath: "assets/books/narnia.jpeg",
    rating: 0,
    userState: "To Read",
    isUserBook: false,
  ),
  ...
  imagePath: "assets/books/aliceinwond.jpeg", // sostituisci con il nome corretto se necessario
  rating: 0,
  userState: "To Read",
  isUserBook:false,
),
